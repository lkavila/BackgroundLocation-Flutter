            ...
            builder: (context, locationData) {
              if (locationData.data != null) {
                ...
                if(locationData.data.speed<=1){
                  velocidad=0;
                }else{velocidad=locationData.data.speed;}
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    onPressed: (){
                      if(_position.running){
                        _position.stop();
                      }else{_position.start();}
                    } ,
                    tooltip: _position.running ? 'Process stop' : 'Process start',
                    child: _position.running ? new Icon(Icons.stop, size: 30,) : new Icon(Icons.play_arrow, size: 40,),
                ),
                SizedBox(height: 10),
                 FloatingActionButton(
